...
| Check | Value | Meaning |
|---|---:|---|
| README required commands | 28/28 | Quick run includes source probes, startup captures, preserved live/fallthrough captures, audit checks, and scorer. |
| Runbook anchors | 17/17 | Detailed runbook covers the same critical steps. |
